...
class _PriconneData:
    ...
    CHARA = {
        ...
        1036: ["镜华", "キョウカ", "Kyouka", "小仓唯", "xcw", "小苍唯", "8岁", "八岁",  "八岁喷水萝莉", "8岁喷水萝莉", "喷水萝莉", "喷水萝"],
        1037: ["智", "トモ", "Tomo", "卜毛"],
        ...
        1046: ["珠希", "タマキ", "Tamaki", "猫剑", "🐱剑", "🐱🗡️", "藏猫️", "藏🐱"],
		...
		9001: ["菜虚昆", "水群机器人","机器人", "群主", "水B", "本群最帅","菜需捆","蔡徐坤"],
		9002: ["仓鼠","机械人","铁皮仓鼠","仓铁鼠皮"],
		9003: ["蒙牛优异C", "柠檬", "柠檬精", "膨胀的柠檬精", "膨胀的🍋精"],
		9004: ["犭苗","苗", "犭", "猫"],
		9005: ["⑤⭐亚里🦈",  "亚里🦈"],
		9006: ["安早"],
		9007: ["汤姆猪俺妹", "汤姆猪"],
		9008: ["九月", "群初音","群员初音"],
		9009: ["迪加雷克斯", "轰喵", "Tigrex"],
		9010: ["鹿乃的绯闻男友", "粽子", "鹿乃的男友", "鹿乃男友"],
